...
function Sharpner() {
  let sharpdata = [
    ...
    {
      img: require("../assets/image/crayon-300x300.jpg"),
      name: "Doms",
  ...
  return (
    ...
    <>
      <div className='container overflow-hidden'>
        ...
        <div className=' omax_tittle fcolor widthmanage text-center my-3 mx-auto text-capitalize' data-aos="fade-up" data-aos-duration="1800">SHARPNER</div>
        ...
        <div className='row p-0 m-0 g-4 pb-5 overflow-hidden'>
          <div className='col-12 col-lg-6 ' data-aos="fade-right" data-aos-duration="1800">
            <div className='h-100 '>
              <img src={require("../assets/image/sharpner-300x300.jpg")} alt="" className='img-fluid object-fit-cover w-100 h-100' />
            </div>
          </div>
          <div className='col-12 col-lg-6 ' data-aos="fade-left" data-aos-duration="1800">
            <div className='h-100  p-4 '>
              ...
              <hr></hr>
              <div className='sec_color fw-medium py-2 text-capitalize'>product Name : <span className='text-secondary'>Sharpner</span></div>
        ...
        <div className=' omax_tittle fcolor text-center mt-5 overflow-hidden' data-aos="zoom-in" data-aos-duration="1200">Products</div>
